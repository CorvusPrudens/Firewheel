...
pub struct NotchFilterNodeConfig<const NUM_CHANNELS: usize>;
...
impl<const NUM_CHANNELS: usize> AudioNode for NotchFilterNode<NUM_CHANNELS> {
    type Configuration = NotchFilterNodeConfig<NUM_CHANNELS>;
...
struct NotchFilterProcessor<const NUM_CHANNELS: usize> {
...
impl<const NUM_CHANNELS: usize> AudioNodeProcessor for NotchFilterProcessor<NUM_CHANNELS> {
    fn process(
        ...
        events.for_each_patch::<NotchFilterNode<NUM_CHANNELS>>(|patch| {
